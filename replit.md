...
- **Departures Management (Admin)**: Create, manage, and duplicate tour departures with individual pricing, dates, capacity, supplements, cancellation policy overrides, and payment deadlines. Includes real-time seat tracking and prevents deletion of departures with active reservations.
...
- **Partial Payment System**: Supports single or scheduled installments, configurable minimum deposit, admin installment management, and client payment schedule viewing.
